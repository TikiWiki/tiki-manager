...
class InstanceBisectGoodCommand extends TikiManagerCommand
{
    protected $instances;
    ...
    protected function configure()
    {
        ...
        $this
            ->setName('instance:bisect:good')
            ->setDescription('Mark a commit as "good" in an ongoing bisect session for a specified Tiki instance.')
            ->setHelp('This command marks a commit as "good" within an active bisect session, indicating that the commit does not contain the bug or issue you are tracking.')
            ->addOption(
                'instance',
                'i',
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $goodCommit = $input->getOption('commit');
        ...
        $bisect->markCommitAsGood($goodCommit);
