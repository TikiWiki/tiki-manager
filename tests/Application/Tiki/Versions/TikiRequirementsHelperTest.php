...
class TikiRequirementsHelperTest extends TestCase
{
    ...
    public function providerForTestFindByBranchName(): array
    {
        ...
        return [
            ...
            ['Test 1.4', '999999999999999.x', $helperOnlyNumeric, '26'], // branch version newer that all in the file
            ['Test 1.5', '999999999999999.9', $helperOnlyNumeric, '26'], // tag version newer that all in the file
            ['Test 1.6', '1.x', $helperOnlyNumeric, '12'], // branch version older that all in the file
            ['Test 1.7', '1.1', $helperOnlyNumeric, '12'], // tag version older that all in the file
            ['Test 1.8', 'some-branch', $helperOnlyNumeric, '26'], // any other branch name
            ...
            ['Test 2.4', '999999999999999.x', $helperWithMaster, '26'], // branch version newer that all in the file
            ['Test 2.5', '999999999999999.9', $helperWithMaster, '26'], // tag version newer that all in the file
            ['Test 2.6', '1.x', $helperWithMaster, '12'], // branch version older that all in the file
            ['Test 2.7', '1.1', $helperWithMaster, '12'], // tag version older that all in the file
            ['Test 2.8', 'some-branch', $helperOnlyNumeric, '26'], // any other branch name
            ...
            ['Test 3.4', '999999999999999.x', $helperWithMinor, '26'], // branch version newer that all in the file
            ['Test 3.5', '999999999999999.9', $helperWithMinor, '26'], // tag version newer that all in the file
            ['Test 3.6', '1.x', $helperWithMinor, '12'], // branch version older that all in the file
            ['Test 3.7', '1.1', $helperWithMinor, '12'], // tag version older that all in the file
            ['Test 3.8', 'some-branch', $helperOnlyNumeric, '26'], // any other branch name
            ...
            ['Test 4.4', '999999999999999.x', $helperShuffled, '26'], // branch version newer that all in the file
            ['Test 4.5', '999999999999999.9', $helperShuffled, '26'], // tag version newer that all in the file
            ['Test 4.6', '1.x', $helperShuffled, '12'], // branch version older that all in the file
            ['Test 4.7', '1.1', $helperShuffled, '12'], // tag version older that all in the file
            ['Test 4.8', 'some-branch', $helperOnlyNumeric, '26'], // any other branch name
        ];
    }
}
